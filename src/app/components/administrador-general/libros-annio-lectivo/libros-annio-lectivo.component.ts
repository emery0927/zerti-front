...
export class LibrosAnnioLectivoComponent implements AfterViewInit, OnInit {
  ...
  displayedColumns: string[] = ['annio_lectivo', 'nombre_sede', 'cantidad_libros', 'cantidad_folios', 'porcentaje_aprobo', 'porcentaje_no_aprobo', 'opciones'];
  ...
  abrirCrearLibro() {
    const dialogRef = this.dialog.open(FormularioCreacionLibrosComponent, {disableClose: true});
