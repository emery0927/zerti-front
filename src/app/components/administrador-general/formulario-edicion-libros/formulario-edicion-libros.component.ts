...
export class FormularioEdicionLibrosComponent implements AfterViewInit, OnInit {

  calendario = CALENDARIO;
  sedes = SEDES_LICEO;

  anioLectivo!: string;
  calendarioSeleccionado!: number;
  ...
  constructor(public dialog: MatDialog, @Inject(MAT_DIALOG_DATA) public dataLibro:any) {
